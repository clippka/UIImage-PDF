...
-(void)setResourceName:(NSString *)resourceName
{
    ...
    self.resourceURL = [ NBPDFView resourceURLForName: self.resourceName ];
}
...
{
    return [ NBPDFView mediaRectForURL:[ NBPDFView resourceURLForName: resourceName ]];
}
